...
const skillCategories = {
  languages: ['JavaScript', 'TypeScript', 'Python', 'Java', 'C', 'C++', 'Dart', 'HTML', 'CSS'],
  frameworks: ['React', 'Tailwind CSS', 'Bootstrap', 'Vite', 'Flutter', 'React Native', 'Node.js', 'Express', 'Spring Boot'],
  databases: ['PostgreSQL', 'SQLite'],
  tools: ['Git', 'GitHub', 'GitLab', 'Docker', 'Azure DevOps', 'VS Code', 'Android Studio', 'JetBrains Suite', 'API REST', 'OVH', 'Google Cloud', 'Cloudflare']
}
