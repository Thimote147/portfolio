  ...
  return (
    <div className="glass-effect overflow-hidden h-full group">
      <div className="relative">
        ...
        {!image && <div className="absolute inset-0 bg-gradient-to-t from-black/10 via-transparent to-transparent"></div>}
        {status && (
          <div className="absolute top-4 right-4">
            <span className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-medium backdrop-blur-sm ${
              ...
              {status === 'Live' ? t('projects.status.live') : status === 'In Development' ? t('projects.status.development') : status}
            </span>
          </div>
        )}
        {type && (
        ...
        <div className="flex space-x-4">
          {liveUrl && liveUrl !== '#' && (
            ...
            >
              ...
              {status === 'Live' ? t('projects.links.live') : t('projects.links.demo')}
            </a>
          )}
          {githubUrl && githubUrl !== '#' && (
            <a
