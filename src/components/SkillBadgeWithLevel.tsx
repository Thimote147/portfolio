...
const levelColors = {
  "Débutant": "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300",
...
export default function SkillBadgeWithLevel({ name, level, years }: SkillBadgeWithLevelProps) {
  return (
    <motion.div
